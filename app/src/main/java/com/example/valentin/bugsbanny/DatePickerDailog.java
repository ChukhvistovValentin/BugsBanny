...
public class DatePickerDailog extends Dialog {
    ...
    public DatePickerDailog(Context context, Calendar calendar,
        ...
        lytdate.addView(month, new LayoutParams(
                android.view.ViewGroup.LayoutParams.MATCH_PARENT, //FILL_PARENT,
        ...
        getWindow().setLayout(LayoutParams.MATCH_PARENT, //FILL_PARENT,
        ...
        String months[] = context.getResources().getStringArray(R.array.names_month);
//                new String[]{"Январь", "February", "March",
