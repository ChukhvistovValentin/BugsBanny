...
public class ColorPickerDialog extends Dialog {
    ...
    private static class ColorPickerView extends View {
        ...
        ColorPickerView(Context c, OnColorChangedListener l, int color) {
            ...
            CENTER_X = (metricsB.widthPixels / 2) - 40;
            CENTER_Y = (metricsB.heightPixels / 2) - 40;
            ...
            mPaint.setStrokeWidth(CENTER_RADIUS * 2);//32
...
//                private static final int CENTER_RADIUS = 72;
        private int CENTER_X = 450;
        private int CENTER_Y = 450;
        private int CENTER_RADIUS = 72;
